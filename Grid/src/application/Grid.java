...
public class Grid extends Application
{
	...
	public void start(Stage mainStage) throws MalformedURLException 
	{
		...
		//Logs 1 (row 9)
		MovingObject log1 = new MovingObject(3, 85, 55, 5, (TILE_SIZE*2), logHeight, leftSpawn, row(9), logColor, "RIGHT", true);
		//Logs 2 (row 10)
		MovingObject log2 = new MovingObject(2, 125, 30, 5, (TILE_SIZE*4), logHeight, leftSpawn-75, row(10), logColor, "RIGHT", true);
		//Logs 3 (row 12)
		MovingObject log3 = new MovingObject(2, 65, 55, 5, (TILE_SIZE*3), logHeight, leftSpawn-75, row(12), logColor, "RIGHT", true);
